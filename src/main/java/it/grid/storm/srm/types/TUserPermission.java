...
public class TUserPermission
{
    ...
    {
        Map<String,Object> paramStructure = new HashMap<String,Object>();
    ...
    public static TUserPermission decode(Map<String, Object> inputParam, String name)
    {
        Map<String,Object> permissionData = (Map<String,Object>) inputParam.get(name);
        if (permissionData != null)
        {
            return new TUserPermission(TUserID.decode(permissionData, TUserID.PNAME_USERID),
                                       TPermissionMode.decode(permissionData, TPermissionMode.PNAME_MODE));
        }
        else
        {
            return TUserPermission.makeEmpty();
        }
    }
}
