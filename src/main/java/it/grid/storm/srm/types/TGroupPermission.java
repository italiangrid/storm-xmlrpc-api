...
public class TGroupPermission {
  ...
  public static TGroupPermission makeFileDefault()
  {
    ...
    public static TGroupPermission decode(Map<String, Object> inputParam, String name)
    {
        Map<String,Object> permissionData = (Map<String,Object>) inputParam.get(name);
        if (permissionData != null)
        {
            return new TGroupPermission(TGroupID.decode(permissionData, TGroupID.NAME_GROUPID),
