...
//    }
    ...
    public static TPermissionMode decode(Map<String, Object> inputParam, String name)
    {
        Integer permission = (Integer) inputParam.get(name);
        if (permission != null)
        {
            return TPermissionMode.getTPermissionMode(permission.intValue());
        }
