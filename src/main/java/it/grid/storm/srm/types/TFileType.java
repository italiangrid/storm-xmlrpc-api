...
public class TFileType {
	...
	public static TFileType getTFileType(int type) {

		switch (type) {
		case 0:
			return TFileType.FILE;
		case 1:
			return TFileType.DIRECTORY;
		case 2:
			return TFileType.LINK;
		default:
			return null;
		}
	}

	public static TFileType decode(Map inputParam, String name) {

		Integer fileType = (Integer) inputParam.get(name);
		if (fileType != null)
			return TFileType.getTFileType(fileType.intValue());
		else
			return null;
	}
