...
public class RecursionLevel
{
    ...
    public static final RecursionLevel noRecursion = new RecursionLevel(Recursion.NONE);
    

    public RecursionLevel(Recursion recursionType, Integer level, Integer startingDepth) throws IllegalArgumentException
    {
                ...
                || (recursionType == Recursion.NONE && ((startingDepth != null && startingDepth > 0))))
        {
            throw new IllegalArgumentException("Unable to build the object, illegal arguments: "
                    + "recursionType=" + recursionType + " ,  level=" + level + " , startingDepth=" + startingDepth);
        }
    ...
    public RecursionLevel(Recursion recursionType, Integer level)
    {
        ...
        {
            throw new IllegalArgumentException("Unable to build the object, illegal arguments: "
                    + "recursionType=" + recursionType + " ,  level=" + level);
        }
    ...
    public Integer getRecursionLevel() throws IllegalStateException
    {
        if (!recursionType.isSpecificable())
        {
            throw new IllegalStateException("Unable to get recursion level on Recursion \'" + recursionType
                    + "\' . Not available");
        }
    ...
    public boolean hasStartingDepth() throws IllegalStateException
    {
        ...
        {
            throw new IllegalStateException("Unable to get  starting recursion level on Recursion \'"
    ...
    public Integer getStartingDepth() throws IllegalStateException
    {
        if (!hasStartingDepth())
        {
            throw new IllegalStateException("Unable to get starting recursion level. Not specified");
        }
