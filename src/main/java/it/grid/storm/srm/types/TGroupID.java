...
public class TGroupID {
	...
	public TGroupID(String id) throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException("Unable to construct the TGroupID. Invalid id=" + id);
        }
        groupID = id;
	}
    ...
    public static TGroupID decode(Map param, String name) throws IllegalArgumentException
    {
