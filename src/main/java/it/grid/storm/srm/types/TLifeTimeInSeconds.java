...
public class TLifeTimeInSeconds implements Serializable {
     ...
     */
    public static TLifeTimeInSeconds make(long time, TimeUnit u) throws IllegalArgumentException {
        if (u == null)
        {
            throw new IllegalArgumentException("Unable to build the object, received null TimeUnit");
        }
