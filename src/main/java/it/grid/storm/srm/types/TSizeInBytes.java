...
public class TSizeInBytes implements Serializable {
     ...
     */
    public static TSizeInBytes make(long size, SizeUnit unit) throws IllegalArgumentException {
        if ((unit == null) || (size < 0))
        {
            throw new IllegalArgumentException("Unable to build the object, illegal arguments: size=" + size
                    + " unit=" + unit);
        }
