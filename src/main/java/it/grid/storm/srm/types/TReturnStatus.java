...
public class TReturnStatus implements Serializable
{
    ...
    public TReturnStatus(TStatusCode statusCode) throws IllegalArgumentException
    {
        if (statusCode == null)
        {
            throw new IllegalArgumentException("Unable to create the object, received null parameter");
        }
        this.statusCode = statusCode;
        this.explanation = UNDEFINED_EXPLANATION;
    }
    
    public static TReturnStatus decode(Map<String,Object> fields) throws IllegalArgumentException
    {
        if (fields == null)
        {
            throw new IllegalArgumentException("Unable to create the object, received null parameter");
        }
        return new TReturnStatus(TStatusCode.fromValue((String)fields.get(PNAME_RETURNSTATUS_CODE)), (String)fields.get(PNAME_RETURNSTATUS_EXPLANATIONS));
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (statusCode == null)
        {
            ...
            if (!statusCode.equals(other.statusCode))
            {
                return false;
            }
        return true;
