...
public class TCheckSumValue
{
    ...
    public TCheckSumValue(String value) throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException("Unable to construct the TCheckSumValue. Invalid value="
                    + value);
        }
        this.value = value;
    }
    ...
    public static TCheckSumValue decode(Map<String, Object> param, String name) throws IllegalArgumentException
    {
