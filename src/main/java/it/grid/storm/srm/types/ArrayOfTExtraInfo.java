...
public class ArrayOfTExtraInfo implements Serializable {
	...
	/**
	 * Fills this class using the values found in a structure inside a
	 * Hashtable. The Hashtable may contain different structures inside, all are
	 * identifiend by a name. Used for communication with the FE.
	 * 
	 * @param inputParam
	 *            Hashtable to read.
	 * @param fieldName
	...
	public static ArrayOfTExtraInfo decode(XmlRpcArray array)
			throws IllegalArgumentException {
		if (array == null) {
			throw new IllegalArgumentException("Unable to build the instance. Received null argument: array=" + array);
		}
