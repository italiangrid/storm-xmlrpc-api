...
public class BackendApi {
   ...
   */
	 ...
	 *          the dn of the user
	 * @param userFQANS
	 *          a list of not-null/not-empty fqan values
	 * @return an object representing the operation result
	 * @throws ApiException
	 *           if is unable to perform the remote call
	 * @throws IllegalArgumentException
	 *           if the provided elements are invalid
	 */
	public PingOutputData ping(String userDN, List<String> userFQANS)
		throws ApiException, IllegalArgumentException {

		return PingExecutor.execute(storm, userDN, userFQANS);
	}

	public PingOutputData ping(String userDN) throws ApiException,
	...
	public SurlArrayRequestOutputData putDone(String userDN,
		List<String> userFQANS, List<String> surls, TRequestToken requestToken)
		throws ApiException {

		return PutDoneExecutor.execute(storm, userDN, userFQANS, surls,
			requestToken);
	}
	...
	public LsOutputData ls(String userDN, List<String> surls,
	...
	public LsOutputData ls(String userDN, List<String> surls, Integer count)
		throws ApiException {
	...
	public LsOutputData ls(String userDN, List<String> userFQANS,
		...
		return LsExecutor
			.execute(storm, userDN, userFQANS, surls, recursion, count);
	}
	...
	public LsOutputData lsDetailed(String userDN, List<String> surls)
		throws ApiException {
	...
	public LsOutputData lsDetailed(List<String> surls, Integer count)
		throws ApiException {
	...
	public FileTransferOutputData prepareToPut(String userDN,
		List<String> userFQANS, String surl) throws ApiException {
	...
	public FileTransferOutputData prepareToPut(String userDN, String surl,
		...
		return PtPExecutor.execute(storm, userDN, surl, desiredFileLifetime,
			desiredPinLifetime);
	}
	...
	public FileTransferOutputData prepareToPut(String surl,
		...
		return PtPExecutor.execute(storm, surl, desiredFileLifetime,
			desiredPinLifetime);
	}
	...
	public FileTransferOutputData prepareToPutOverwrite(String userDN,
		List<String> userFQANS, String surl) throws ApiException {
	...
	public FileTransferOutputData prepareToPutOverwrite(String surl,
		...
		return PtPExecutor.executeOverwrite(storm, surl, desiredFileLifetime,
			desiredPinLifetime);
	}
	...
	public SurlArrayRequestOutputData prepareToPutStatus(String userDN,
		List<String> userFQANS, String surl, TRequestToken requestToken)
		throws ApiException {

		return SurlRequestStatusExecutor.execute(storm, userDN, userFQANS, surl,
			requestToken, SurlRequestStatusExecutor.SurlRequestType.PTP);
	}
	...
	public SurlArrayRequestOutputData prepareToPutStatus(String userDN,
		...
		return SurlRequestStatusExecutor.execute(storm, userDN, userFQANS, surl,
			SurlRequestStatusExecutor.SurlRequestType.PTP);
	}

	public SurlArrayRequestOutputData prepareToPutStatus(String userDN,
		String surl, TRequestToken requestToken) throws ApiException {

		return SurlRequestStatusExecutor.execute(storm, userDN, surl, requestToken,
			SurlRequestStatusExecutor.SurlRequestType.PTP);
	}
	...
	public SurlArrayRequestOutputData prepareToPutStatus(String userDN,
		...
		return SurlRequestStatusExecutor.execute(storm, userDN, surl,
			SurlRequestStatusExecutor.SurlRequestType.PTP);
	}
	...
	public SurlArrayRequestOutputData prepareToPutStatus(String surl,
		...
		return SurlRequestStatusExecutor.execute(storm, surl, requestToken,
			SurlRequestStatusExecutor.SurlRequestType.PTP);
	}
	...
	public SurlArrayRequestOutputData prepareToPutStatus(String surl)
		...
		return SurlRequestStatusExecutor.execute(storm, surl,
			SurlRequestStatusExecutor.SurlRequestType.PTP);
	}

	public PtGOutputData prepareToGet(String userDN, List<String> userFQANS,
		String surl) throws ApiException {

		return PtGExecutor.execute(storm, userDN, userFQANS, surl);
	}

	public PtGOutputData prepareToGet(String userDN, String surl)
		throws ApiException {
	...
	public PtGOutputData prepareToGet(String surl, List<String> transferProtocols)
		throws ApiException {

		return PtGExecutor.execute(storm, surl, transferProtocols);
	}

	public SurlArrayRequestOutputData prepareToGetStatus(String userDN,
		List<String> userFQANS, String surl, TRequestToken requestToken)
		throws ApiException {

		return SurlRequestStatusExecutor.execute(storm, userDN, userFQANS, surl,
			requestToken, SurlRequestStatusExecutor.SurlRequestType.PTG);
	}
	...
	public SurlArrayRequestOutputData prepareToGetStatus(String userDN,
		...
		return SurlRequestStatusExecutor.execute(storm, userDN, userFQANS, surl,
			SurlRequestStatusExecutor.SurlRequestType.PTG);
	}
	...
	public SurlArrayRequestOutputData releaseFiles(String userDN,
		List<String> userFQANS, List<String> surls, TRequestToken requestToken)
		throws ApiException {
	...
	public SurlArrayRequestOutputData releaseFiles(List<String> surls,
		TRequestToken requestToken) throws ApiException {
	...
	public OutputData extendFileLifeTime(String userDN, List<String> userFQANS,
		String surl, long fileLifetime) throws ApiException {

		throw new ApiException(
			"Unable to perform extendFileLifeTime call. Not implemented");
	}

	public OutputData extendPinLifeTime(String userDN, List<String> userFQANS,
		TRequestToken requestToken, String surl, long pinLifetime)
		throws ApiException {

		throw new ApiException(
			"Unable to perform extendPinLifeTime call. Not implemented");
	}

	public RequestOutputData abortRequest(String userDN, List<String> userFQANS,
		TRequestToken requestToken) throws ApiException {

		return AbortRequestExecutor.execute(storm, userDN, userFQANS, requestToken);
	}

	public RequestOutputData abortRequest(String userDN,
		TRequestToken requestToken) throws ApiException {

		return AbortRequestExecutor.execute(storm, userDN, requestToken);
	}

	public RequestOutputData abortRequest(TRequestToken requestToken)
		throws ApiException {

		return AbortRequestExecutor.execute(storm, requestToken);
	}

	public SurlArrayRequestOutputData abortFiles(String userDN,
		List<String> userFQANS, TRequestToken requestToken, List<String> surls)
		throws ApiException {

		return AbortFilesExecutor.execute(storm, userDN, userFQANS, surls,
			requestToken);
	}

	public SurlArrayRequestOutputData abortFiles(String userDN,
		TRequestToken requestToken, List<String> surls) throws ApiException {

		return AbortFilesExecutor.execute(storm, userDN, surls, requestToken);
	}

	public SurlArrayRequestOutputData abortFiles(TRequestToken requestToken,
		List<String> surls) throws ApiException {
	...
	public OutputData reserveSpace(String userDN, List<String> userFQANS,
		String spaceAlias, TRetentionPolicyInfo retentionPolicyInfo,
		...
		throw new ApiException(
			"Unable to perform reserveSpace call. Not implemented");
	}
	...
	public OutputData getSpaceMetaData(String userDN, List<String> userFQANS,
		ArrayOfTSpaceToken arrayOfSpaceTokens) throws ApiException {

		throw new ApiException(
			"Unable to perform getSpaceMetaData call. Not implemented");
	}

	public OutputData getSpaceTokens(String userDN, List<String> userFQANS,
		String spaceTokenDescription) throws ApiException {

		throw new ApiException(
			"Unable to perform getSpaceTokens call. Not implemented");
	}

	public OutputData releaseSpace(String userDN, List<String> userFQANS,
		TSpaceToken spaceToken) throws ApiException {

		throw new ApiException(
			"Unable to perform releaseSpace call. Not implemented");
	}

	public OutputData releaseSpaceForced(String userDN, List<String> userFQANS,
		TSpaceToken spaceToken) throws ApiException {

		throw new ApiException(
			"Unable to perform releaseSpaceForced call. Not implemented");
	}

	public RequestOutputData mkdir(String userDN, List<String> userFQANS,
		String surl) throws ApiException {

		return MkdirExecutor.execute(storm, userDN, userFQANS, surl);
	}

	public RequestOutputData mkdir(String userDN, String surl)
		throws ApiException {
	...
	public RequestOutputData rmdir(String userDN, List<String> userFQANS,
		String surl) throws ApiException {

		return RmdirExecutor.execute(storm, userDN, userFQANS, surl);
	}

	public RequestOutputData rmdir(String userDN, String surl)
		throws ApiException {
	...
	public RequestOutputData rmdirRecursively(String userDN,
		List<String> userFQANS, String surl) throws ApiException {

		return RmdirExecutor.executeRecursive(storm, userDN, userFQANS, surl);
	}

	public RequestOutputData rmdirRecursively(String userDN, String surl)
		throws ApiException {
	...
	public RequestOutputData rm(String userDN, List<String> userFQANS,
		List<String> surls) throws ApiException {

		return RmExecutor.execute(storm, userDN, userFQANS, surls);
	}

	public RequestOutputData rm(String userDN, List<String> surls)
		throws ApiException {
	...
	public RequestOutputData mv(String userDN, List<String> userFQANS,
		String fromSurl, String toSurl) throws ApiException {

		return MvExecutor.execute(storm, userDN, userFQANS, fromSurl, toSurl);
	}

	public RequestOutputData mv(String userDN, String fromSurl, String toSurl)
		throws ApiException {

		return MvExecutor.execute(storm, userDN, fromSurl, toSurl);
	}

	public RequestOutputData mv(String fromSurl, String toSurl)
		throws ApiException {
