...
public class PingOutputData implements OutputData {
	 ...
	 */
	public PingOutputData(String versionInfo, String beVersion, String beOs)
		throws IllegalArgumentException {

		if (versionInfo == null || beVersion == null || beOs == null) {
			throw new IllegalArgumentException(
				"Unable to create the object, received null parameters: versionInfo="
					+ versionInfo + " beVersion=" + beVersion + " beOs=" + beOs);
		}
		if (versionInfo.trim().equals("") || beVersion.trim().equals("")
			|| beOs.trim().equals("")) {
			throw new IllegalArgumentException(
				"Unable to create the object, received invalid parameters: versionInfo="
					+ versionInfo + " beVersion=" + beVersion + " beOs=" + beOs);
		}
	...
	public boolean equals(Object obj) {
		...
		} else if (!beOs.equals(other.beOs)) {
			return false;
		}
		if (beVersion == null) {
		...
		} else if (!beVersion.equals(other.beVersion)) {
			return false;
		}
		if (versionInfo == null) {
