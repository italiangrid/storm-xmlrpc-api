 ...
 *
 */
public class SurlArrayRequestOutputData extends RequestOutputData implements OutputData 
{

    private HashMap<String, TReturnStatus> surlStatus = new HashMap<String, TReturnStatus>();

    public SurlArrayRequestOutputData(TReturnStatus status, List<SurlStatus> statuses)
    {
        super(status);
    ...
    public int hashCode()
    {
        ...
        result = prime * result + ((surlStatus == null) ? 0 : surlStatus.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (surlStatus == null)
        {
            ...
            if (!surlStatus.equals(other.surlStatus))
            {
                return false;
            }
        return true;
