...
public class LsOutputData extends RequestOutputData implements OutputData {
	...
	public static class SurlInfo {
		...
		public int hashCode() {
			...
			int result = 1;
			result = prime * result
				+ ((checkSumType == null) ? 0 : checkSumType.hashCode());
			result = prime * result
				+ ((checkSumValue == null) ? 0 : checkSumValue.hashCode());
			result = prime * result
				+ ((creationTime == null) ? 0 : creationTime.hashCode());
			result = prime * result
				+ ((groupPermission == null) ? 0 : groupPermission.hashCode());
			result = prime * result + ((lifetime == null) ? 0 : lifetime.hashCode());
			result = prime * result
				+ ((lifetimeLeft == null) ? 0 : lifetimeLeft.hashCode());
			result = prime * result + ((locality == null) ? 0 : locality.hashCode());
			result = prime * result
				+ ((modificationTime == null) ? 0 : modificationTime.hashCode());
			result = prime * result
				+ ((otherPermission == null) ? 0 : otherPermission.hashCode());
			result = prime * result
				+ ((retentionPolicy == null) ? 0 : retentionPolicy.hashCode());
			result = prime * result + ((size == null) ? 0 : size.hashCode());
			result = prime * result
				+ ((spaceTokenArray == null) ? 0 : spaceTokenArray.hashCode());
			result = prime * result + ((status == null) ? 0 : status.hashCode());
			result = prime * result + ((stfn == null) ? 0 : stfn.hashCode());
			result = prime * result
				+ ((storageType == null) ? 0 : storageType.hashCode());
			result = prime * result
				+ ((subpathInfo == null) ? 0 : subpathInfo.hashCode());
		...
		public boolean equals(Object obj) {
			...
			} else if (!groupPermission.equals(other.groupPermission)) {
				return false;
			}
			if (lifetime == null) {
			...
			} else if (!lifetimeLeft.equals(other.lifetimeLeft)) {
				return false;
			}
			if (locality == null) {
			...
			} else if (!otherPermission.equals(other.otherPermission)) {
				return false;
			}
			...
			} else if (!spaceTokenArray.equals(other.spaceTokenArray)) {
				return false;
			}
			if (status == null) {
			...
			} else if (!stfn.equals(other.stfn)) {
				return false;
			}
			if (storageType == null) {
			...
			} else if (!subpathInfo.equals(other.subpathInfo)) {
				return false;
			}
			if (type == null) {
				if (other.type != null) {
	...
	public static class Builder {
		...
		public Builder token(TRequestToken token) throws IllegalArgumentException {
			...
			if (token == null) {
				throw new IllegalArgumentException(
					"Unable to feed the builder, invalid arguments: token =" + token);
			}
			this.token = token;
			return this;
		}
