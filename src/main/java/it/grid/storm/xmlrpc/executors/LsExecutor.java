...
public class LsExecutor
{
            ...
            List<String> surls) throws ApiException
    {
        ...
        try
        {
            parameters = LsEncoder.getInstance().encodeDetailed(userDN, userFQANS, surls);
        } catch(IllegalArgumentException e)
        {
            throw new ApiException("Unable to encode ls parameters. IllegalArgumentException: "
                    + e.getMessage());
            ...
            List<String> surls, RecursionLevel recursion) throws ApiException
    {
        ...
        try
        {
            parameters = LsEncoder.getInstance().encodeDetailed(userDN, userFQANS, surls, recursion);
        } catch(IllegalArgumentException e)
        {
            throw new ApiException("Unable to encode ls parameters. IllegalArgumentException: "
                    + e.getMessage());
    ...
    {
        if ((storm == null ? "null" : "not null") == null || userDN == null || userFQANS == null || userFQANS.isEmpty() || surls == null
                || surls.isEmpty() || count == null || count <= 0)
        {
            throw new IllegalArgumentException("Unable to call ls command. Received null arguments: storm="
                    + storm + " userDN=" + userDN + " userFQANS=" + userFQANS + " surls=" + surls
                    + " count=" + count);
        }
        Map<String, Object> parameters;
        try
        {
            parameters = LsEncoder.getInstance().encode(userDN, userFQANS, surls, count);
        } catch(IllegalArgumentException e)
        {
            throw new ApiException("Unable to encode ls parameters. IllegalArgumentException: "
                    + e.getMessage());
            ...
            List<String> surls, RecursionLevel recursion, Integer count) throws ApiException
    {
        ...
        try
        {
            parameters = LsEncoder.getInstance().encode(userDN, userFQANS, surls, recursion, count);
        } catch(IllegalArgumentException e)
        {
            throw new ApiException("Unable to encode ls parameters. IllegalArgumentException: "
                    + e.getMessage());
    ...
    private static LsOutputData doIt(synchcall storm, Map<String, Object> parameters) throws ApiException
    {
        ...
        {
            throw new ApiException("Unable to perform ls call. XmlRpcFault: " + e.getMessage());
        }
        try
        {
        ...
        {
            throw new ApiException("Unable to decode ls call output. IllegalArgumentException: "
                    + e.getMessage());
