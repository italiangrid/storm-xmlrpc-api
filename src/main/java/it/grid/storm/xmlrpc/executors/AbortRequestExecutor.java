...
public class AbortRequestExecutor
{
    ...
    {
        if (storm == null || userDN == null || userFQANS == null || userFQANS.isEmpty() || requestToken == null)
        {
    ...
    private static RequestOutputData doIt(synchcall storm, Map<String, Object> parameters) throws ApiException
    {
        ...
        {
            throw new ApiException("Unable to perform abortRequest call. XmlRpcFault: " + e.getMessage());
        }
        try
        {
        ...
        {
            throw new ApiException("Unable to decode abortRequest call output. IllegalArgumentException: "
                    + e.getMessage());
        } catch(DecodingException e)
        {
            throw new ApiException("Unable to decode abortRequest call output. DecodingException: " + e.getMessage());
        }
    }
}
