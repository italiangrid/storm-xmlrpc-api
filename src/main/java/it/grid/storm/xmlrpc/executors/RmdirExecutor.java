...
public class RmdirExecutor {
	...
	public static RequestOutputData execute(synchcall storm, String userDN,
		...
		if (storm == null || userDN == null || userFQANS == null
			...
			throw new IllegalArgumentException(
				"Unable to call rmdir command. Received null arguments: storm="
					+ (storm == null ? "null" : "not null") + " userDN=" + userDN
					+ " userFQANS=" + userFQANS + " surl=" + surl);
		}
		Map<String, Object> parameters;
		try {
			parameters = SurlRequestEncoder.getInstance().encode(userDN, userFQANS,
				surl);
		} catch (IllegalArgumentException e) {
			throw new ApiException(
				"Unable to encode rmdir parameters. IllegalArgumentException: "
					+ e.getMessage());
		}
	...
	public static RequestOutputData execute(synchcall storm, String surl)
		throws ApiException {
	...
	public static RequestOutputData executeRecursive(synchcall storm,
		...
		Map<String, Object> parameters;
		try {
			parameters = RmdirRequestEncoder.getInstance().encodeRecursive(userDN,
				userFQANS, surl);
		} catch (IllegalArgumentException e) {
			throw new ApiException(
				"Unable to encode rmdir parameters. IllegalArgumentException: "
	...
	public static RequestOutputData executeRecursive(synchcall storm, String surl)
		throws ApiException {
	...
	private static RequestOutputData doIt(synchcall storm,
		...
		try {
			...
			throw new ApiException("Unable to perform rmdir call. XmlRpcFault: "
				+ e.getMessage());
		}
		try {
			...
			throw new ApiException(
				"Unable to decode rmdir call output. IllegalArgumentException: "
					+ e.getMessage());
		} catch (DecodingException e) {
			throw new ApiException(
				"Unable to decode rmdir call output. DecodingException: "
					+ e.getMessage());
		}
	}
}
