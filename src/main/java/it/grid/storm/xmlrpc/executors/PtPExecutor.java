...
public class PtPExecutor {
	...
	public static FileTransferOutputData execute(synchcall storm, String userDN,
		List<String> userFQANS, String surl) throws ApiException {

		if (storm == null || userDN == null || userFQANS == null
			|| userFQANS.isEmpty() || surl == null || surl.trim().isEmpty()) {
			throw new IllegalArgumentException(
				"Unable to call ptp command. Received null arguments: storm="
					+ (storm == null ? "null" : "not null") + " userDN=" + userDN
					+ " userFQANS=" + userFQANS + " surl=" + surl);
		}
		...
		try {
			...
			throw new ApiException(
				"Unable to encode ptp parameters. IllegalArgumentException: "
					+ e.getMessage());
		}
	...
	public static FileTransferOutputData execute(synchcall storm, String surl)
		...
		if (storm == null || surl == null || surl.trim().isEmpty()) {
			throw new IllegalArgumentException(
				"Unable to call ptp command. Received null arguments: storm="
	...
	public static FileTransferOutputData executeOverwrite(synchcall storm,
		String userDN, List<String> userFQANS, String surl) throws ApiException {
		...
		Map<String, Object> parameters;
		try {
			parameters = PtPEncoder.getInstance().encodeOverwrite(userDN, userFQANS,
				surl);
		} catch (IllegalArgumentException e) {
			throw new ApiException(
				"Unable to encode ptp parameters. IllegalArgumentException: "
	...
	public static FileTransferOutputData executeOverwrite(synchcall storm,
		String userDN, String surl) throws ApiException {
	...
	public static FileTransferOutputData execute(synchcall storm, String userDN,
		...
		if (storm == null || userDN == null || userFQANS == null
			|| userFQANS.isEmpty() || surl == null || surl.trim().isEmpty()
			|| transferProtocols == null || transferProtocols.isEmpty()) {
			throw new IllegalArgumentException(
				"Unable to call ptp command. Received null arguments: storm="
					+ (storm == null ? "null" : "not null") + " userDN=" + userDN
					+ " userFQANS=" + userFQANS + " surl=" + surl + " transferProtocols="
					+ transferProtocols);
		}
		Map<String, Object> parameters;
		try {
	...
	public static FileTransferOutputData execute(synchcall storm, String userDN,
		...
		if (storm == null || userDN == null || surl == null
			|| surl.trim().isEmpty() || transferProtocols == null
			|| transferProtocols.isEmpty()) {
			throw new IllegalArgumentException(
				"Unable to call ptp command. Received null arguments: storm="
					+ (storm == null ? "null" : "not null") + " userDN=" + userDN
					+ " surl=" + surl + " transferProtocols=" + transferProtocols);
		}
		Map<String, Object> parameters;
		try {
			parameters = PtPEncoder.getInstance().encode(userDN, surl,
	...
	public static FileTransferOutputData executeOverwrite(synchcall storm,
		String userDN, List<String> userFQANS, String surl,
		List<String> transferProtocols) throws ApiException {
	...
	public static FileTransferOutputData executeOverwrite(synchcall storm,
		String userDN, String surl, List<String> transferProtocols)
		throws ApiException {
	...
	public static FileTransferOutputData execute(synchcall storm, String userDN,
		...
		if (storm == null || userDN == null || surl == null
			...
			throw new IllegalArgumentException(
				"Unable to call ptp command. Received null arguments: storm="
					+ (storm == null ? "null" : "not null") + " userDN=" + userDN
					+ " surl=" + surl + " desiredFileLifetime=" + desiredFileLifetime);
		}
		Map<String, Object> parameters;
		try {
			if (desiredPinLifetime == null || desiredPinLifetime.isEmpty()) {
	...
	public static FileTransferOutputData executeOverwrite(synchcall storm,
		...
		try {
			if (desiredPinLifetime == null || desiredPinLifetime.isEmpty()) {
				parameters = PtPEncoder.getInstance().encodeOverwrite(userDN,
					userFQANS, surl, desiredFileLifetime);
			} else {
				parameters = PtPEncoder.getInstance().encodeOverwrite(userDN,
					userFQANS, surl, desiredFileLifetime, desiredPinLifetime);
			}
	...
	public static FileTransferOutputData executeOverwrite(synchcall storm,
		String userDN, String surl, TLifeTimeInSeconds desiredFileLifetime,
		TLifeTimeInSeconds desiredPinLifetime) throws ApiException {
	...
	public static FileTransferOutputData executeOverwrite(synchcall storm,
		...
		try {
			if (desiredPinLifetime == null || desiredPinLifetime.isEmpty()) {
				parameters = PtPEncoder.getInstance().encodeOverwrite(userDN,
					userFQANS, surl, transferProtocols, desiredFileLifetime);
			} else {
				parameters = PtPEncoder.getInstance().encodeOverwrite(userDN,
					userFQANS, surl, transferProtocols, desiredFileLifetime,
					desiredPinLifetime);
	...
	private static FileTransferOutputData doIt(synchcall storm,
		...
		try {
			...
			throw new ApiException("Unable to perform ptp call. XmlRpcFault: "
				+ e.getMessage());
		}
		try {
			...
			throw new ApiException(
				"Unable to decode ptp call output. IllegalArgumentException: "
					+ e.getMessage());
		} catch (DecodingException e) {
			throw new ApiException(
				"Unable to decode ptp call output. DecodingException: "
					+ e.getMessage());
		}
	}
