...
public class MkdirExecutor {
	...
	public static RequestOutputData execute(synchcall storm, String userDN,
		...
		if (storm == null || userDN == null || userFQANS == null
			...
			throw new IllegalArgumentException(
				"Unable to call mkdir command. Received null arguments: storm="
		...
		try {
			...
			throw new ApiException(
				"Unable to encode mkdir parameters. IllegalArgumentException: "
					+ e.getMessage());
		}
	...
	private static RequestOutputData doIt(synchcall storm,
		...
		try {
			...
			throw new ApiException("Unable to perform mkdir call. XmlRpcFault: "
				+ e.getMessage());
		}
		try {
			...
			throw new ApiException(
				"Unable to decode mkdir call output. IllegalArgumentException: "
					+ e.getMessage());
		} catch (DecodingException e) {
			throw new ApiException(
				"Unable to decode mkdir call output. DecodingException: "
					+ e.getMessage());
		}
	}
