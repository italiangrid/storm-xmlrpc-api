...
public class PutDoneExecutor {
	...
	public static SurlArrayRequestOutputData execute(synchcall storm,
		...
		try {
			...
			throw new ApiException(
				"Unable to encode pd parameters. IllegalArgumentException: "
					+ e.getMessage());
		}
	...
	private static SurlArrayRequestOutputData doIt(synchcall storm,
		...
		try {
			...
			throw new ApiException("Unable to perform pd call. XmlRpcFault: "
				+ e.getMessage());
		}
		try {
			...
			throw new ApiException(
				"Unable to decode pd call output. IllegalArgumentException: "
					+ e.getMessage());
		} catch (DecodingException e) {
			throw new ApiException(
				"Unable to decode pd call output. DecodingException: " + e.getMessage());
		}
	}
