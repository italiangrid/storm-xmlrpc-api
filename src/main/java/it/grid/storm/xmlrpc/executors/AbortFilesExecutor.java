...
public class AbortFilesExecutor {
	...
	public static SurlArrayRequestOutputData execute(synchcall storm,
		...
		try {
			...
			throw new ApiException(
				"Unable to encode abortFiles parameters. IllegalArgumentException: "
					+ e.getMessage());
		}
	...
	private static SurlArrayRequestOutputData doIt(synchcall storm,
		...
		try {
			...
			throw new ApiException("Unable to perform abortFiles call. XmlRpcFault: "
				+ e.getMessage());
		}
		try {
			...
			throw new ApiException(
				"Unable to decode abortFiles call output. IllegalArgumentException: "
					+ e.getMessage());
		} catch (DecodingException e) {
			throw new ApiException(
				"Unable to decode abortFiles call output. DecodingException: "
					+ e.getMessage());
		}
	}
}
