...
public class PtGExecutor {
	...
	public static PtGOutputData execute(synchcall storm, String userDN,
		...
		if (storm == null || userDN == null || userFQANS == null
			...
			throw new IllegalArgumentException(
				"Unable to call ptg command. Received null arguments: storm="
		...
		try {
			...
			throw new ApiException(
				"Unable to encode ptg parameters. IllegalArgumentException: "
					+ e.getMessage());
		}
	...
	public static PtGOutputData execute(synchcall storm, String surl)
		throws ApiException {
	...
	private static PtGOutputData doIt(synchcall storm,
		...
		try {
			...
			throw new ApiException("Unable to perform ptg call. XmlRpcFault: "
				+ e.getMessage());
		}
		try {
			...
			throw new ApiException(
				"Unable to decode ptg call output. IllegalArgumentException: "
					+ e.getMessage());
		} catch (DecodingException e) {
			throw new ApiException(
				"Unable to decode ptg call output. DecodingException: "
					+ e.getMessage());
		}
	}
