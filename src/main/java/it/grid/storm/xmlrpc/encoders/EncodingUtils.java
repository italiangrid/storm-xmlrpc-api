...
public class EncodingUtils
{
    ...
    public static void checkFQANS(List<String> userFQANS) throws IllegalArgumentException
    {
    ...
    public static void checkSurls(List<String> surls) throws IllegalArgumentException 
    {
    ...
    public static void checkToken(TRequestToken requestToken) throws IllegalArgumentException 
    {
        if (requestToken == null || requestToken.getValue() == null || requestToken.getValue().trim().isEmpty())
        {
            throw new IllegalArgumentException("Unable to encode the parameters. "
    ...
    public static void checkRecursionLevel(RecursionLevel recursion) throws IllegalArgumentException 
    {
        if (recursion == null)
        {
            throw new IllegalArgumentException("Unable to encode the parameters. "
    ...
    public static void checkTransferProtocols(List<String> transferProtocols) throws IllegalArgumentException 
    {
        if (transferProtocols == null || transferProtocols.isEmpty())
        {
            throw new IllegalArgumentException("Unable to encode the parameters. "
                    + "Received empty Transfer Protocols argument: transferProtocols=" + transferProtocols);
        }
        for (String transferProtocol : transferProtocols)
        {
            ...
            {
                throw new IllegalArgumentException("Unable to encode the parameters."
                        + " Received empty Transfer Protocol element: transferProtocol=" + transferProtocol);
            }
        }
    }

    public static void checkTime(TLifeTimeInSeconds time) throws IllegalArgumentException 
    {
