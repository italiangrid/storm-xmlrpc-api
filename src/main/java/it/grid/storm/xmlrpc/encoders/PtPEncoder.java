...
public class PtPEncoder
{
    ...
    public Map<String, Object> encodeOverwrite(String userDN, List<String> userFQANS, String surl,
            List<String> transferProtocols) throws IllegalArgumentException
    {
        Map<String, Object> encoding = encodeOverwrite(userDN, surl, transferProtocols);
        EncodingUtils.checkFQANS(userFQANS);
    ...
    public Map<String, Object> encodeOverwrite(String userDN, String surl, List<String> transferProtocols)
    {
    ...
    public Map<String, Object> encodeOverwrite(String surl, List<String> transferProtocols)
    {
        EncodingUtils.checkSurl(surl);
        EncodingUtils.checkTransferProtocols(transferProtocols);
    ...
    public Map<String, Object> encode(String userDN, String surl, TLifeTimeInSeconds desiredFileLifetime)
    {
    ...
    public Map<String, Object> encode(String surl, TLifeTimeInSeconds desiredFileLifetime)
    {
        EncodingUtils.checkSurl(surl);
    ...
    public Map<String, Object> encodeOverwrite(String userDN, List<String> userFQANS, String surl,
            TLifeTimeInSeconds desiredFileLifetime) throws IllegalArgumentException
    {
        Map<String, Object> encoding = encodeOverwrite(userDN, surl, desiredFileLifetime);
        EncodingUtils.checkFQANS(userFQANS);
   ...
   public Map<String, Object> encodeOverwrite(String surl, TLifeTimeInSeconds desiredFileLifetime)
   {
       EncodingUtils.checkSurl(surl);
       EncodingUtils.checkTime(desiredFileLifetime);
    ...
    public Map<String, Object> encode(String userDN, List<String> userFQANS, String surl,
            ...
            throws IllegalArgumentException
    {
        Map<String, Object> encoding = encode(userDN, surl, transferProtocols, desiredFileLifetime);
        EncodingUtils.checkFQANS(userFQANS);
        encoding.put(XmlRpcParameters.FQANS_KEY, userFQANS.toArray());
        return encoding;
    }
    ...
    public Map<String, Object> encode(String userDN, String surl, List<String> transferProtocols,
            TLifeTimeInSeconds desiredFileLifetime)
    {
        Map<String, Object> encoding = encode(surl, transferProtocols, desiredFileLifetime);
        EncodingUtils.checkDN(userDN);
    ...
    public Map<String, Object> encodeOverwrite(String userDN, List<String> userFQANS, String surl,
            ...
            throws IllegalArgumentException
    {
        Map<String, Object> encoding = encodeOverwrite(userDN, surl, transferProtocols, desiredFileLifetime);
        EncodingUtils.checkFQANS(userFQANS);
    ...
    public Map<String, Object> encodeOverwrite(String userDN, String surl, List<String> transferProtocols,
            TLifeTimeInSeconds desiredFileLifetime)
    {
        Map<String, Object> encoding = encodeOverwrite(surl, transferProtocols, desiredFileLifetime);
        EncodingUtils.checkDN(userDN);
    ...
    public Map<String, Object> encode(String userDN, List<String> userFQANS, String surl,
            ...
            throws IllegalArgumentException
    {
        Map<String, Object> encoding = encode(userDN, surl, desiredFileLifetime, desiredPinLifetime);
        EncodingUtils.checkFQANS(userFQANS);
  ...
  {
        Map<String, Object> encoding = encode(surl, desiredFileLifetime, desiredPinLifetime);
        EncodingUtils.checkDN(userDN);
    ...
    public Map<String, Object> encodeOverwrite(String userDN, List<String> userFQANS, String surl,
            ...
            throws IllegalArgumentException
    {
        Map<String, Object> encoding = encodeOverwrite(userDN, surl, desiredFileLifetime, desiredPinLifetime);
        EncodingUtils.checkFQANS(userFQANS);
    ...
    public Map<String, Object> encodeOverwrite(String userDN, String surl,
            TLifeTimeInSeconds desiredFileLifetime, TLifeTimeInSeconds desiredPinLifetime)
    {
        Map<String, Object> encoding = encodeOverwrite(surl, desiredFileLifetime, desiredPinLifetime);
        EncodingUtils.checkDN(userDN);
    ...
    {
        Map<String, Object> encoding = encode(userDN, surl, transferProtocols, desiredFileLifetime, desiredPinLifetime);
        EncodingUtils.checkFQANS(userFQANS);
    ...
    public Map<String, Object> encode(String userDN, String surl, List<String> transferProtocols,
            TLifeTimeInSeconds desiredFileLifetime, TLifeTimeInSeconds desiredPinLifetime)
    {
        Map<String, Object> encoding = encode(surl, transferProtocols, desiredFileLifetime, desiredPinLifetime);
        EncodingUtils.checkDN(userDN);
    ...
    public Map<String, Object> encodeOverwrite(String userDN, List<String> userFQANS, String surl,
            ...
            TLifeTimeInSeconds desiredPinLifetime) throws IllegalArgumentException
    {
        Map<String, Object> encoding = encodeOverwrite(userDN, surl, transferProtocols, desiredFileLifetime, desiredPinLifetime);
        EncodingUtils.checkFQANS(userFQANS);
    ...
    public Map<String, Object> encodeOverwrite(String userDN, String surl, List<String> transferProtocols,
            TLifeTimeInSeconds desiredFileLifetime, TLifeTimeInSeconds desiredPinLifetime)
    {
        Map<String, Object> encoding = encodeOverwrite(surl, transferProtocols, desiredFileLifetime, desiredPinLifetime);
        EncodingUtils.checkDN(userDN);
