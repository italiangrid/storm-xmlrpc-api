...
public class LsEncoder extends SurlArrayRequestEncoder
{
    ...
    public Map<String, Object> encode(String userDN, List<String> surls, RecursionLevel recursion)
    {
        Map<String, Object> encoding = super.encode(userDN, surls);
        enrich(encoding, recursion);
        return encoding;
    ...
    public Map<String, Object> encodeDetailed(String userDN, List<String> surls, RecursionLevel recursion)
    {
        Map<String, Object> encoding = super.encode(userDN, surls);
        enrich(encoding, recursion);
        setDetailed(encoding);
    ...
    public Map<String, Object> encodeDetailed(List<String> surls, RecursionLevel recursion)
    {
        Map<String, Object> encoding = super.encode(surls);
        enrich(encoding, recursion);
        setDetailed(encoding);
    ...
    public Map<String, Object> encode(String userDN, List<String> surls, Integer maxReturnedEntries)
    {
        Map<String, Object> encoding = super.encode(userDN, surls);
    ...
    public Map<String, Object> encode(List<String> surls, Integer maxReturnedEntries)
    {
        Map<String, Object> encoding = super.encode(surls);
    ...
    public Map<String, Object> encodeDetailed(String userDN, List<String> surls, Integer maxReturnedEntries)
    {
        Map<String, Object> encoding = super.encode(userDN, surls);
    ...
    public Map<String, Object> encodeDetailed(List<String> surls, Integer maxReturnedEntries)
    {
        Map<String, Object> encoding = super.encode(surls);
    ...
    public Map<String, Object> encode(List<String> surls, RecursionLevel recursion, Integer maxReturnedEntries)
    {
        Map<String, Object> encoding = super.encode(surls);
    ...
    public Map<String, Object> encodeDetailed(List<String> surls, RecursionLevel recursion, Integer maxReturnedEntries)
    {
        Map<String, Object> encoding = super.encode(surls);
    ...
    private void enrich(Map<String, Object> encoding, RecursionLevel recursion, Integer maxReturnedEntries)
    {
        enrich(encoding, recursion);
        enrich(encoding, maxReturnedEntries);
    }
