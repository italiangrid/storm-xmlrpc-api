...
public class ManageFileTransferEncoder {
	...
	public Map<String, Object> encodeWithSurls(String userDN,
	...
	public Map<String, Object> encodeWithSurls(String userDN, List<String> surls,
	...
	public Map<String, Object> encodeWithSurls(List<String> surls,
		TRequestToken requestToken) {
